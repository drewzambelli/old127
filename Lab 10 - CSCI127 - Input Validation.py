...
#This program prints debugging stuff
...
def main():
    ...
    ###################################
    userInput = int(input("Enter a square integer:"))

    while not is_square(userInput):
        print("That is not a perfect square. Try again:", userInput)
        userInput = int(input("Enter a square integer:"))
        if is_square(userInput) == True:
            print(perfectSquareChecker(userInput))
