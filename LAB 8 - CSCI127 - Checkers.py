...
def main():
   size = int(input("What size is the checkerboard?"))
   drawBoard(size)
   setupScreen(size)
   piece = createPiece("red")
   row = int(input("What row will you move piece to?"))
   col = int(input("What column will you move piece to?"))
